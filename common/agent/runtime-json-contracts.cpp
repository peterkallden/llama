...
bool common_agent_runtime_apply_safe_tool_defaults_to_json(
    ...
    } else if (tool_name == "repository_search" || tool_name == "repository.search" || tool_name == "workspace.search") {
    ...
    } else if (tool_name == "repository_read" || tool_name == "repository.read" || tool_name == "workspace.read") {
    ...
    } else if (tool_name == "repository_list" || tool_name == "repository.list" || tool_name == "workspace.list") {
        if (!normalized_arguments.contains("path")) { normalized_arguments["path"] = ""; changed = true; }
