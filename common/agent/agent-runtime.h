...
struct common_agent_request { std::string prompt, session_id; std::vector<common_memory_hit> memories; size_t max_iterations = 2, max_reflection_rounds = 1; };
