...
std::vector<common_tool_definition> builtin_definitions() {
    ...
    return {
        ...
        tool("resource_read", "Read a bounded host-owned resource representation or byte range by its opaque URI.", R"({"type":"object","additionalProperties":false,"required":["uri"],"properties":{"uri":{"type":"string","minLength":1,"maxLength":512},"representation":{"type":"string","minLength":1,"maxLength":64},"offset":{"type":"integer","minimum":0,"maximum":1073741824},"max_bytes":{"type":"integer","minimum":1,"maximum":32768}}})", object, "builtin.resource_read", common_tool_risk_class::local_read),
