...
std::vector<common_tool_profile> builtin_profiles() {
    return {
        ...
        policy_profile(profile("research", "Memory profile with repository inspection and safe network-read declarations.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "plan_get", "plan_propose", "repository.search", "repository.read", "repository.list", "repository.diff", "resource_read", "web_search", "web_fetch"}), true, true),
        policy_profile(profile("developer-read", "Read-only workspace and repository inspection tools.", {"calculator", "time_now", "repository.list", "repository.search", "repository.read", "repository.diff", "repository.log", "repository.status", "repository.changed_files", "workspace.list", "workspace.read", "workspace.search", "diagnostics.symbol", "diagnostics.references", "diagnostics.call_hierarchy", "resource_read"}), false, false),
        policy_profile(profile("all-configured", "All catalogued tools, still subject to host policy and confirmation.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "memory_propose_update", "memory_propose_forget", "memory_link", "memory_compact_propose", "plan_get", "plan_propose", "repository.list", "repository.search", "repository.read", "repository.diff", "workspace.list", "workspace.read", "workspace.search", "workspace.patch", "development.build", "development.test", "diagnostics.compile", "diagnostics.symbol", "diagnostics.references", "diagnostics.call_hierarchy", "diagnostics.test_failures", "diagnostics.format", "diagnostics.include_graph", "dataset.list", "dataset.inspect", "dataset.schema", "dataset.sample", "dataset.validate", "data.query", "data.filter", "data.aggregate", "data.join", "data.transform", "statistics.describe", "artifact.export", "resource_read", "web_search", "web_fetch"}), true, true),
    };
}
