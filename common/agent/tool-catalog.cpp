...
std::vector<common_tool_profile> builtin_profiles() {
    return {
        ...
        policy_profile(profile("developer-read", "Read-only workspace and repository inspection tools.", {"calculator", "time_now", "repository_list", "repository_search", "repository_read", "repository_diff", "repository_log", "repository_status", "repository_changed_files", "workspace_list", "workspace_read", "workspace_search", "resource_read"}), false, false),
        policy_profile(profile("all-configured", "All catalogued tools, still subject to host policy and confirmation.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "memory_propose_update", "memory_propose_forget", "memory_link", "memory_compact_propose", "plan_get", "plan_propose", "repository_list", "repository_search", "repository_read", "repository_diff", "repository_log", "repository_status", "repository_changed_files", "workspace_list", "workspace_read", "workspace_search", "build_target", "test_run", "resource_read", "web_search", "web_fetch"}), true, true),
    };
}
