...
std::vector<common_tool_profile> builtin_profiles() {
    return {
        ...
        policy_profile(profile("developer-read", "Read-only workspace and repository inspection tools.", {"calculator", "time_now", "repository_list", "repository_search", "repository_read", "repository.diff", "repository_log", "repository_status", "repository_changed_files", "workspace.list", "workspace.read", "workspace.search", "resource_read"}), false, false),
