...
std::vector<common_tool_definition> builtin_definitions() {
    ...
    return {
        ...
        tool("memory_remember", "Propose a policy-gated persistent memory.", R"({"type":"object","additionalProperties":false,"required":["kind","content","importance","confidence","rationale"],"properties":{"kind":{"type":"string"},"content":{"type":"string","minLength":1,"maxLength":2048},"importance":{"type":"number","minimum":0,"maximum":1},"confidence":{"type":"number","minimum":0,"maximum":1},"rationale":{"type":"string","minLength":1,"maxLength":512}}})", object, "builtin.memory_remember", common_tool_risk_class::memory_proposal, true),
