...
std::vector<common_tool_definition> builtin_definitions() {
    ...
    return {
        ...
        tool("data.query", "Run a bounded backend-neutral structured data query.", R"({"type":"object","additionalProperties":false,"required":["dataset"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"select":{"type":"array","maxItems":32,"items":{"type":"string","maxLength":128}},"where":{"type":"array","maxItems":16,"items":{"type":"object"}},"order_by":{"type":"array","maxItems":8,"items":{"type":"object"}},"limit":{"type":"integer","minimum":1,"maximum":1000}}})", object, "builtin.data.query", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.filter", "Filter a bounded dataset with declarative predicates.", R"({"type":"object","additionalProperties":false,"required":["dataset","conditions"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"conditions":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}},"limit":{"type":"integer","minimum":1,"maximum":1000}}})", object, "builtin.data.filter", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.aggregate", "Aggregate a bounded dataset with host-approved functions.", R"({"type":"object","additionalProperties":false,"required":["dataset","measures"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"group_by":{"type":"array","maxItems":16,"items":{"type":"string","maxLength":128}},"measures":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}}}})", object, "builtin.data.aggregate", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.join", "Join two bounded datasets using declarative key mappings.", R"({"type":"object","additionalProperties":false,"required":["left","right","on"],"properties":{"left":{"type":"string","minLength":1,"maxLength":256},"right":{"type":"string","minLength":1,"maxLength":256},"type":{"type":"string","enum":["inner","left"]},"on":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}}}})", object, "builtin.data.join", common_tool_risk_class::local_read, false, 30000, 65536),
...
std::vector<common_tool_profile> builtin_profiles() {
    return {
        ...
        policy_profile(profile("research", "Memory profile with repository inspection and safe network-read declarations.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "plan_get", "plan_propose", "repository_list", "repository_search", "repository_read", "repository.diff", "repository_log", "resource_read", "web_search", "web_fetch"}), true, true),
        policy_profile(profile("developer-read", "Read-only workspace and repository inspection tools.", {"calculator", "time_now", "repository_list", "repository_search", "repository_read", "repository.diff", "repository_log", "repository_status", "repository_changed_files", "workspace.list", "workspace.read", "workspace.search", "diagnostics.symbol", "diagnostics.references", "resource_read"}), false, false),
        policy_profile(profile("all-configured", "All catalogued tools, still subject to host policy and confirmation.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "memory_propose_update", "memory_propose_forget", "memory_link", "memory_compact_propose", "plan_get", "plan_propose", "repository_list", "repository_search", "repository_read", "repository.diff", "repository_log", "repository_status", "repository_changed_files", "workspace.list", "workspace.read", "workspace.search", "workspace.patch", "development.build", "development.test", "diagnostics.compile", "diagnostics.symbol", "diagnostics.references", "diagnostics.test_failures", "diagnostics.format", "diagnostics.include_graph", "dataset.list", "dataset.inspect", "dataset.schema", "dataset.sample", "dataset.validate", "data.query", "data.filter", "data.aggregate", "data.join", "data.transform", "statistics.describe", "artifact.export", "resource_read", "web_search", "web_fetch"}), true, true),
    };
}
