...
std::vector<common_tool_definition> builtin_definitions() {
    ...
    return {
        ...
        tool("repository.list", "List a bounded directory tree inside the runtime repository root.", R"({"type":"object","additionalProperties":false,"properties":{"path":{"type":"string","maxLength":512},"depth":{"type":"integer","minimum":0,"maximum":3}}})", object, "builtin.repository_list", common_tool_risk_class::local_read),
        ...
        tool("repository_status", "Return the bounded Git working-tree status.", R"({"type":"object","additionalProperties":false})", object, "builtin.repository_status", common_tool_risk_class::local_read),
        tool("repository_changed_files", "List bounded Git working-tree changes.", R"({"type":"object","additionalProperties":false})", object, "builtin.repository_changed_files", common_tool_risk_class::local_read),
        tool("workspace.list", "List a bounded directory tree inside the host-owned workspace.", R"({"type":"object","additionalProperties":false,"properties":{"path":{"type":"string","maxLength":512},"depth":{"type":"integer","minimum":0,"maximum":3}}})", object, "builtin.repository_list", common_tool_risk_class::local_read),
        ...
        tool("diagnostics.references", "Find bounded symbol references using the host diagnostics provider or a text fallback.", R"({"type":"object","additionalProperties":false,"required":["symbol"],"properties":{"symbol":{"type":"string","minLength":1,"maxLength":256},"definition_path":{"type":"string","maxLength":512},"definition_line":{"type":"integer","minimum":1,"maximum":1000000},"max_results":{"type":"integer","minimum":1,"maximum":128}}})", object, "builtin.diagnostics.references", common_tool_risk_class::local_read, false, 10000, 65536),
        tool("diagnostics.call_hierarchy", "Find bounded callers and callees through the host semantic diagnostics provider.", R"({"type":"object","additionalProperties":false,"required":["symbol"],"properties":{"symbol":{"type":"string","minLength":1,"maxLength":256},"path_hint":{"type":"string","maxLength":512},"direction":{"type":"string","enum":["callers","callees","both"]},"max_depth":{"type":"integer","minimum":1,"maximum":8},"max_results":{"type":"integer","minimum":1,"maximum":128}}})", object, "builtin.diagnostics.call_hierarchy", common_tool_risk_class::local_read, false, 10000, 65536),
        ...
        tool("dataset.inspect", "Inspect bounded metadata for a host-owned dataset file.", R"({"type":"object","additionalProperties":false,"required":["path"],"properties":{"path":{"type":"string","minLength":1,"maxLength":512}}})", object, "builtin.dataset.inspect", common_tool_risk_class::local_read),
        tool("dataset.schema", "Infer a bounded schema from a host-owned CSV dataset.", R"({"type":"object","additionalProperties":false,"required":["path"],"properties":{"path":{"type":"string","minLength":1,"maxLength":512},"max_rows":{"type":"integer","minimum":1,"maximum":10000}}})", object, "builtin.dataset.schema", common_tool_risk_class::local_read),
        tool("dataset.sample", "Return a bounded head sample from a host-owned CSV dataset.", R"({"type":"object","additionalProperties":false,"required":["path"],"properties":{"path":{"type":"string","minLength":1,"maxLength":512},"rows":{"type":"integer","minimum":1,"maximum":100}}})", object, "builtin.dataset.sample", common_tool_risk_class::local_read),
        tool("dataset.validate", "Validate a host-approved dataset against bounded declarative rules.", R"({"type":"object","additionalProperties":false,"required":["dataset","rules"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":512},"rules":{"type":"array","minItems":1,"maxItems":32,"items":{"type":"object"}}}})", object, "builtin.dataset.validate", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.query", "Run a bounded backend-neutral structured data query.", R"({"type":"object","additionalProperties":false,"required":["dataset"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"select":{"type":"array","maxItems":32,"items":{"type":"string","maxLength":128}},"where":{"type":"array","maxItems":16,"items":{"type":"object"}},"order_by":{"type":"array","maxItems":8,"items":{"type":"object"}},"distinct":{"type":"boolean"},"offset":{"type":"integer","minimum":0,"maximum":100000},"limit":{"type":"integer","minimum":1,"maximum":1000},"max_scan_rows":{"type":"integer","minimum":1,"maximum":100000},"max_result_rows":{"type":"integer","minimum":1,"maximum":10000}}})", object, "builtin.data.query", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.filter", "Filter a bounded dataset with declarative predicates.", R"({"type":"object","additionalProperties":false,"required":["dataset","conditions"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"conditions":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}},"limit":{"type":"integer","minimum":1,"maximum":1000},"max_scan_rows":{"type":"integer","minimum":1,"maximum":100000},"max_result_rows":{"type":"integer","minimum":1,"maximum":10000}}})", object, "builtin.data.filter", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.aggregate", "Aggregate a bounded dataset with host-approved functions.", R"({"type":"object","additionalProperties":false,"required":["dataset","measures"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"group_by":{"type":"array","maxItems":16,"items":{"type":"string","maxLength":128}},"measures":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}},"max_scan_rows":{"type":"integer","minimum":1,"maximum":100000},"max_result_rows":{"type":"integer","minimum":1,"maximum":10000}}})", object, "builtin.data.aggregate", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.join", "Join two bounded datasets using declarative key mappings.", R"({"type":"object","additionalProperties":false,"required":["left","right","on"],"properties":{"left":{"type":"string","minLength":1,"maxLength":256},"right":{"type":"string","minLength":1,"maxLength":256},"type":{"type":"string","enum":["inner","left"]},"on":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}},"max_scan_rows":{"type":"integer","minimum":1,"maximum":100000},"max_result_rows":{"type":"integer","minimum":1,"maximum":10000}}})", object, "builtin.data.join", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("data.transform", "Transform a bounded dataset with host-approved column operations.", R"({"type":"object","additionalProperties":false,"required":["dataset","operations"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"operations":{"type":"array","minItems":1,"maxItems":16,"items":{"type":"object"}}}})", object, "builtin.data.transform", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("statistics.describe", "Describe selected numeric columns in a bounded dataset.", R"({"type":"object","additionalProperties":false,"required":["dataset"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":256},"columns":{"type":"array","maxItems":32,"items":{"type":"string","maxLength":128}},"group_by":{"type":"array","maxItems":16,"items":{"type":"string","maxLength":128}}}})", object, "builtin.statistics.describe", common_tool_risk_class::local_read, false, 30000, 65536),
        tool("artifact.export", "Publish bounded text content as a named host-owned resource artifact.", R"({"type":"object","additionalProperties":false,"required":["name","content"],"properties":{"name":{"type":"string","minLength":1,"maxLength":256},"content":{"type":"string","maxLength":65536},"mime_type":{"type":"string","maxLength":128}}})", object, "builtin.artifact.export", common_tool_risk_class::local_read, false, 5000, 8192),
...
std::vector<common_tool_profile> builtin_profiles() {
    return {
        ...
        policy_profile(profile("research", "Memory profile with repository inspection and safe network-read declarations.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "plan_get", "plan_propose", "repository_list", "repository_search", "repository_read", "repository.list", "repository.search", "repository.read", "repository.diff", "repository_log", "resource_read", "web_search", "web_fetch"}), true, true),
        policy_profile(profile("developer-read", "Read-only workspace and repository inspection tools.", {"calculator", "time_now", "repository_list", "repository_search", "repository_read", "repository.list", "repository.search", "repository.read", "repository.diff", "repository_log", "repository_status", "repository_changed_files", "workspace.list", "workspace.read", "workspace.search", "diagnostics.symbol", "diagnostics.references", "diagnostics.call_hierarchy", "resource_read"}), false, false),
        policy_profile(profile("all-configured", "All catalogued tools, still subject to host policy and confirmation.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "memory_propose_update", "memory_propose_forget", "memory_link", "memory_compact_propose", "plan_get", "plan_propose", "repository_list", "repository_search", "repository_read", "repository.list", "repository.search", "repository.read", "repository.diff", "repository_log", "repository_status", "repository_changed_files", "workspace.list", "workspace.read", "workspace.search", "workspace.patch", "development.build", "development.test", "diagnostics.compile", "diagnostics.symbol", "diagnostics.references", "diagnostics.call_hierarchy", "diagnostics.test_failures", "diagnostics.format", "diagnostics.include_graph", "dataset.list", "dataset.inspect", "dataset.schema", "dataset.sample", "dataset.validate", "data.query", "data.filter", "data.aggregate", "data.join", "data.transform", "statistics.describe", "artifact.export", "resource_read", "web_search", "web_fetch"}), true, true),
    };
}
