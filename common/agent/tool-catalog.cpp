...
std::vector<common_tool_definition> builtin_definitions() {
    ...
    std::vector<common_tool_definition> definitions = {
        ...
        tool("dataset.validate", "Validate a host-approved dataset against bounded declarative rules.", R"({"type":"object","additionalProperties":false,"required":["dataset","rules"],"properties":{"dataset":{"type":"string","minLength":1,"maxLength":512,"x-agent-type":"dataset_ref"},"rules":{"type":"array","minItems":1,"maxItems":32,"items":{"type":"object"}}}})", object, "builtin.dataset.validate", common_tool_risk_class::local_read, false, 30000, 65536),
    ...
    set_model_schema("document.table", R"({"type":"object","additionalProperties":false,"required":["resource"],"properties":{"resource":{"type":"string","minLength":1,"maxLength":512,"x-agent-type":"resource_ref"},"table":{"type":"string","minLength":1,"maxLength":256},"table_index":{"type":"integer","minimum":0,"maximum":1000000},"node_id":{"type":"string","minLength":1,"maxLength":512,"x-agent-type":"table_ref"}}})");
