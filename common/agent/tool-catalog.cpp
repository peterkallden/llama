...
std::vector<common_tool_profile> builtin_profiles() {
    return {
        ...
        profile("research", "Memory profile with repository inspection and safe network-read declarations.", {"calculator", "time_now", "memory_search", "memory_get", "memory_inspect", "memory_conflict_check", "memory_remember", "plan_get", "plan_propose", "repository_list", "repository_search", "repository_read", "mock_web_search", "web_fetch"}),
    };
}
