...
int main() {
    ...
    for (VkPhysicalDevice device : devices) {
        ...
        const bool supports_6x5 = sampled_astc_supported(
            device, VK_FORMAT_ASTC_6x5_UNORM_BLOCK);
        const bool supports_8x5 = sampled_astc_supported(
            device, VK_FORMAT_ASTC_8x5_UNORM_BLOCK);
        const bool supports_10x5 = sampled_astc_supported(
            device, VK_FORMAT_ASTC_10x5_UNORM_BLOCK);
        ...
        std::printf("%s: ASTC 4x4 sampled=%s, ASTC 5x5 sampled=%s, ASTC 6x6 sampled=%s, ASTC 6x5 sampled=%s, ASTC 8x5 sampled=%s, ASTC 10x5 sampled=%s, ASTC 8x6 sampled=%s, ASTC 10x6 sampled=%s, ASTC 8x8 sampled=%s, ASTC 10x8 sampled=%s\n",
