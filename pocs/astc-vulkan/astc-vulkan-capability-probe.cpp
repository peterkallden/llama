...
int main() {
    ...
    for (VkPhysicalDevice device : devices) {
        ...
        std::printf("%s: ASTC 4x4 sampled=%s, ASTC 5x5 sampled=%s, ASTC 6x6 sampled=%s, ASTC 8x5 sampled=%s, ASTC 10x5 sampled=%s, ASTC 8x6 sampled=%s, ASTC 10x6 sampled=%s, ASTC 8x8 sampled=%s, ASTC 10x8 sampled=%s\n",
