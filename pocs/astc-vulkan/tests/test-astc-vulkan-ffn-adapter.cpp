...
int main() {
    ...
    assert(binding.fallback_policy.preferred == astc_vulkan_fallback_format::kQ4_K_M);
    assert(binding.fallback_policy.low_memory == astc_vulkan_fallback_format::kQ3_K_M);
