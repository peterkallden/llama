...
int main() {
    ...
    constexpr auto format_6x5 = ggml_vk_astc_6x5_unorm_rgba;
    ...
    static_assert(format_6x5.block_size_bytes == 16, "ASTC blocks must be 128 bits");
    ...
    static_assert(format_6x5.texels_per_block() == 30, "ASTC 6x5 texel count changed");
    ...
    assert_close(format_6x5.nominal_bits_per_texel(), 128.0 / 30.0);
