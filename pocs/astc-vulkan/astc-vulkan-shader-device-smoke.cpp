...
int main(int argc, char ** argv) {
    ...
    if (argc < 3 || (format_name != "4x4" && format_name != "5x5" &&
                     format_name != "6x6" && format_name != "6x5" && format_name != "8x5" &&
    ...
    const VkFormat format = format_name == "4x4" ? VK_FORMAT_ASTC_4x4_UNORM_BLOCK :
                            ...
                            format_name == "6x5" ? VK_FORMAT_ASTC_6x5_UNORM_BLOCK :
    ...
    const uint32_t block_height = (format_name == "6x5" || format_name == "8x5" || format_name == "10x5") ? 5 :
    ...
    const uint64_t block_count = ggml_vk_astc_image_block_count(
        ...
        format_name == "6x5" ? ggml_vk_astc_6x5_unorm_rgba :
