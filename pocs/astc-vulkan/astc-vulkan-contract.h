...
inline constexpr ggml_vk_astc_format_contract ggml_vk_astc_6x5_unorm_rgba = {
    "ASTC 6x5 UNORM RGBA", 6, 5, 16, 4,
};
...
inline constexpr ggml_vk_astc_format_contract ggml_vk_astc_10x5_unorm_rgba = {
    "ASTC 10x5 UNORM RGBA", 10, 5, 16, 4,
};
...
inline constexpr ggml_vk_astc_format_contract ggml_vk_astc_10x6_unorm_rgba = {
    "ASTC 10x6 UNORM RGBA", 10, 6, 16, 4,
};
