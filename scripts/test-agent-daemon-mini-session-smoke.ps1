...
$requestsPath = Join-Path $env:TEMP "llama-agent-daemon-mini-session-smoke-requests.txt"
$stdoutPath = Join-Path $env:TEMP "llama-agent-daemon-mini-session-smoke-stdout.log"
$stderrPath = Join-Path $env:TEMP "llama-agent-daemon-mini-session-smoke-stderr.log"
