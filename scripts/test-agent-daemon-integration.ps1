...
if ($haveEmbeddingModel) {
    ...
    Invoke-MiniLearningScenario -ExePath $daemonPath -BaseArgs $miniArgs
} else {
    Write-Host "mini_learning=skipped"
}
