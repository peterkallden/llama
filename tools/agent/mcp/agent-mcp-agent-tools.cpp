...
const char * task_schema() {
    return R"({"type":"object","additionalProperties":false,"required":["task"],"properties":{"task":{"type":"string","minLength":1,"maxLength":4096},"max_result_bytes":{"type":"integer","minimum":1,"maximum":16384},"delegation_depth":{"type":"integer","minimum":0,"maximum":16}}})";
}

const char * summary_schema() {
    return R"({"type":"object","additionalProperties":false,"required":["text"],"properties":{"text":{"type":"string","minLength":1,"maxLength":16384}}})";
}
